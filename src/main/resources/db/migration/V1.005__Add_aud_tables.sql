...
create table course_students_aud (course_id integer not null, rev integer not null, revtype smallint, students_id integer not null, primary key (course_id, rev, students_id));
create table course_teachers_aud (course_id integer not null, rev integer not null, revtype smallint, teachers_id integer not null, primary key (course_id, rev, teachers_id));
